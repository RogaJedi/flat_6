...
class AddGame extends StatefulWidget {
  ...
  AddGame({required this.onNoteAdded});
}
            ...
            ElevatedButton(
              onPressed: () {
                if (_noteControllerTitle.text.isNotEmpty && _noteControllerImageURL.text.isNotEmpty && _noteControllerShortInfo.text.isNotEmpty && _noteControllerFullInfo.text.isNotEmpty && _noteControllerCost.text.isNotEmpty) {
                  Note newNote = Note(name: _noteControllerTitle.text, text: _noteControllerShortInfo.text, imageUrl:_noteControllerImageURL.text, fullinfo: _noteControllerFullInfo.text, cost: int.parse(_noteControllerCost.text), amount: 0);
